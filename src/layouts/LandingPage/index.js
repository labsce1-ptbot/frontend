        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={8}>
            ...
            <div className="header">
              ...
              <h1>PTbOt</h1>
              <p>Sign up and start scheduling your vacations!</p>
            </div>
              ...
              <CardBody className={classes.listItems}>
                <ul className={classes.listItems}>
                  <li className="listItems">
                    Schedule away messages for Slack
                  </li>
                  <li className="listItems">
                  ...
                  <li className="listItems">
                    All of your stored vacations are removed from our database
                    the day after your vacation ends
                  </li>
                  <li className="listItems">
