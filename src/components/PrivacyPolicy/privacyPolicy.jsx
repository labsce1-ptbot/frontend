...
function PrivacyPolicy(props) {
  ...
  return (
    <React.Fragment>
      ...
      <Card className={classes.privacyPolicy}>
        <CardHeader color="primary">
          <h3 className={classes.cardTitleWhite}>Privacy Policy</h3>
        </CardHeader>
        <CardBody>
          <div className={classes.typo}>
            <p>
              Please read our:{" "}
              <a href="https://app.termly.io/document/privacy-policy/f94c898a-b29b-47a2-97a4-73800d002019">
                Privacy Policy
              </a>
            </p>
          </div>
